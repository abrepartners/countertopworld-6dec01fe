...
const faqItems = [
  { q: 'What is your standard turnaround time for builder projects?', a: `${claims.turnaroundDays} from template to install for standard kitchen countertop projects. Multi-unit projects get dedicated scheduling to keep your build on track. We provide a firm timeline before we start.` },
...
export default function BuildersPage() {
  ...
  useEffect(() => {
    ...
    svcScript.textContent = JSON.stringify({
      ...
      description: `In-house stone countertop fabrication and installation for builders and contractors. ${claims.turnaroundPhrase}, volume pricing, laser templating, CNC fabrication, and Sasso-Lux finishing.`,
    });
  ...
  const benefits = [
    { Icon: Clock, title: `${claims.turnaroundPhrase}.`, desc: `Standard projects go from template to install in ${claims.turnaroundDays}. Multi-unit projects get dedicated scheduling. We give you a firm date and hit it.` },
        ...
        <section aria-labelledby="builder-hero-heading" className="relative min-h-[85vh] flex flex-col items-center justify-center pt-28 pb-0 px-6 overflow-hidden bg-obsidian">
          ...
          <div className={`text-center max-w-4xl mx-auto z-10 flex flex-col items-center transition-all duration-[1200ms] ease-out ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-[17px] md:text-[19px] text-cool-gray font-light leading-relaxed max-w-xl mb-10">
              You need a fabricator who won't hold up your build. Two Arkansas locations, 1,000+ slabs in stock, and a {claims.turnaroundPhrase} from template to install. No middlemen. No subcontractors.
            </p>
