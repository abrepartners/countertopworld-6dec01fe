      ...
      <div className="relative container-custom section-padding text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button size="lg" onClick={scrollToForm} className="bg-orange-500 hover:bg-orange-600 text-white text-lg px-12 py-4 rounded-lg font-semibold border-0">
              Get Project Quote
              <ArrowRight className="ml-3 h-6 w-6" />
            </Button>
            <Button size="lg" variant="outline" onClick={scrollToForm} className="border-2 border-white hover:bg-white text-lg px-12 py-4 rounded-lg font-semibold text-slate-950">
